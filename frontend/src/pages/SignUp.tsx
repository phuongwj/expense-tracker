          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className="grid grid-cols-2 gap-3 mb-4">
              <div>
                ...
                <input {...register('firstName')} placeholder="Alex" className={inp(!!errors.firstName)} />
                {errors.firstName && <p className="mt-1 text-xs text-red-600">{errors.firstName.message}</p>}
              </div>
              <div>
                <label className="block text-xs font-medium text-gray-600 uppercase tracking-wide mb-1.5">Last name</label>
                <input {...register('lastName')} placeholder="Chen" className={inp(!!errors.lastName)} />
            ...
            <div className="mb-4">
              ...
              <input {...register('email')} type="email" placeholder="alex@dal.ca" className={inp(!!errors.email)} />
              {errors.email && <p className="mt-1 text-xs text-red-600">{errors.email.message}</p>}
            </div>
            <div className="mb-4">
              <label className="block text-xs font-medium text-gray-600 uppercase tracking-wide mb-1.5">University</label>
              <input {...register('university')} placeholder="Dalhousie University" className={inp(!!errors.university)} />
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <div>
                ...
                <input {...register('password')} type="password" placeholder="Min 8 chars" className={inp(!!errors.password)} />
              ...
              <div>
                ...
                <input {...register('confirmPassword')} type="password" placeholder="Repeat" className={inp(!!errors.confirmPassword)} />
