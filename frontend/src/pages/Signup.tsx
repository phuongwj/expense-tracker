          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className="flex gap-3 mb-4">
              <div className="flex-1">
                ...
                <input {...register('firstName')} type="text" placeholder="Alex" className={inp(!!errors.firstName)} />
                {errors.firstName && <p className="mt-1 text-xs text-red-600">{errors.firstName.message}</p>}
              </div>
              <div className="flex-1">
                <label className="block text-xs font-medium text-gray-600 uppercase tracking-wide mb-1.5">Last name</label>
                <input {...register('lastName')} type="text" placeholder="Chen" className={inp(!!errors.lastName)} />
            ...
            <div className="mb-6">
              ...
              <input {...register('password')} type="password" placeholder="••••••••" autoComplete="new-password" className={inp(!!errors.password)} />
